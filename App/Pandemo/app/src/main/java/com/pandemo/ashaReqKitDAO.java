...
public class ashaReqKitDAO {
    String kitid,kitstaus,requestdt,previousrequestdate,alotqrcode,workstatus,allotedate,ashaworker_id,public_id,distict_id,category_id,categoryname,pubname,pubcontact,casestatus,infectiontype;

    public ashaReqKitDAO(String kitid, String kitstaus, String requestdt, String previousrequestdate, String alotqrcode, String workstatus, String allotedate, String ashaworker_id, String public_id, String distict_id, String category_id, String categoryname, String pubname, String pubcontact, String casestatus, String infectiontype) {
        this.kitid = kitid;

...
public class AshaServiceHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_asha_service_history);
    ...
    private void getdata() {
        ...
        try {
            progressDoalog = new ProgressDialog(AshaServiceHistory.this);
            progressDoalog.setMessage("Loading...");
            progressDoalog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
            progressDoalog.show();

            MainApi service = Connection.getcon().create(MainApi.class);
            Call<List<serviceDAO>> call = service.getAshaServiceHistory(
                    user
            );
            ...
            call.enqueue(new Callback<List<serviceDAO>>() {
                ...
                public void onResponse(Call<List<serviceDAO>> call, Response<List<serviceDAO>> response) {
                    ...
                    try {
                        ...
                        ashaServiceAdapter recyclerViewAdapter = new ashaServiceAdapter(AshaServiceHistory.this, userList);

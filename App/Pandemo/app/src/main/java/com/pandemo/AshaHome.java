...
public class AshaHome extends AppCompatActivity {
    ...
    public void getAlerts(){
        try {
            progressDoalog = new ProgressDialog(AshaHome.this);
            ...
            call.enqueue(new Callback<List<alertDAO>>() {
                ...
                public void onResponse(Call<List<alertDAO>> call, Response<List<alertDAO>> response) {
                    ...
                    try {
                        ...
                        alertAdapter recyclerViewAdapter = new alertAdapter(AshaHome.this, userList);
    ...
    public void kitRequests(View view) {
    ...
    public void verifiedKits(View view) {
        Intent i = new Intent(getApplicationContext(), AshaVerifiedKits.class);
        i.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
        startActivity(i);
    }

    public void servicehistory(View view) {
        Intent i = new Intent(getApplicationContext(), AshaServiceHistory.class);
        i.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
        startActivity(i);
    }

    public void serviceRequests(View view) {
        Intent i = new Intent(getApplicationContext(), AshaServiceRequests.class);
        i.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
        startActivity(i);
    }

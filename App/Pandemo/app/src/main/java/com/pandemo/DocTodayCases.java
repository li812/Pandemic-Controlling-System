...
public class DocTodayCases extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doc_today_cases);
    ...
    private void getdata() {
        try {
            progressDoalog = new ProgressDialog(DocTodayCases.this);
            progressDoalog.setMessage("Loading...");
            progressDoalog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
            progressDoalog.show();

            MainApi service = Connection.getcon().create(MainApi.class);
            Call<List<docTestCasesDAO>> call = service.docTodayTestCases(
                    user,
                    dist
            );
            ...
            call.enqueue(new Callback<List<docTestCasesDAO>>() {
                ...
                public void onResponse(Call<List<docTestCasesDAO>> call, Response<List<docTestCasesDAO>> response) {
                    ...
                    try {
                        ...
                        docTestCasesAdapter recyclerViewAdapter = new docTestCasesAdapter(DocTodayCases.this, userList);

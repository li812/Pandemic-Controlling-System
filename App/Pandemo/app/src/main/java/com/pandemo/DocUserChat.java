...
public class DocUserChat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doc_user_chat);
        ...
        Gson gson = new Gson();
        ob = gson.fromJson(v, publicDAO.class);

        docname = findViewById(R.id.docname);
        docname.setText("Chat with " + ob.getPubname());
    ...
    private void getdata() {
        try {
            ...
            Call<List<chatDAO>> call = service.getDocChat(
                    user,
                    ob.getPubid()
            );
            ...
            call.enqueue(new Callback<List<chatDAO>>() {
                ...
                public void onResponse(Call<List<chatDAO>> call, Response<List<chatDAO>> response) {
                    ...
                    try {
                        ...
                        docChatAdapter recyclerViewAdapter = new docChatAdapter(DocUserChat.this, userList);
    ...
    public void send(View view) {
        ...
        try {
            if (msg.getText().toString().equals("")) {
                ...
                progressDoalog = new ProgressDialog(DocUserChat.this);
                ...
                MainApi service = Connection.getcon().create(MainApi.class);
                Call<List<Result>> call = service.docSendMessage(
...
//        Intent a = new Intent(getApplicationContext(), DocPublicList.class);
